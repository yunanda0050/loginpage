      ...
      <div>
...

        {
              ...
              >
                <div>
                  {boards.map((board , index) => (
                    ...
                    dark:hover:text-[#635fc7] dark:text-white ${board.isActive && " bg-[#635fc7] rounded-full text-white mr-8"} `}
                    key={index}
                    onClick={() => {
                  ...
                  <div
                    ...
                    ease-in-out cursor-pointer text-[#635fc7] px-5 py-4 hover:bg-[#635fc71a0]
                ...
                <div
                className=' mx-2 py-4 relative space-x-2 bg-slate-200
          ...
          {isSideBarOpen ? (
            ...
            mb-8 px-8 py-4 hover:bg-[#635fc71a] dark:hover:bg-white space-x-2 justify-center
            my-4 text-gray-500'
            >
              <img src={hideSidebarIcon} className=' min-2-[20px]' alt="hideSidebarIcon" />
