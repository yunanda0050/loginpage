...
function AddEditBoardModal({setBoardModalOpen , type}) {
  ...
  return (
    ...
    className='
        ...
        justify-center items-center flex bg-[#000000] bg-opacity-50'
    >
        {/* Modal Section */}
        <div
        ...
        <div className=' mt-8 flex flex-col space-y-3'>
            ...
            <input
            className=' bg-transparent px-4 py-4 rounded-md text-sm border
            ...
            >
                ...
                newColumns.map((column , index) =>(
                    <div key={index} className=' flex items-center w-full'>
                        ...
                        text-sm border bordey-gray-600 outline-none focus:outline-[#735fc7]'
                        onChange={(e) => {
